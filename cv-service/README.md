...
- **One remaining spurious low-confidence read ("1")** from a tiny (20×12px), clearly-erroneous plate-detector false positive on a distant/small vehicle — a real accuracy limitation of the plate detector at small scale, not a pipeline bug, and not something either fix above targets.
